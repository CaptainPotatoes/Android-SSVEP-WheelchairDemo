...
#include "classifySSVEP4.h"
#include "classifySSVEP5.h"
/*Additional Includes*/
#include <jni.h>
...
Java_com_mahmoodms_bluetooth_eegssvepwheelchairdemo_DeviceControlActivity_jClassifySSVEP5(
    ...
    return classifySSVEP5(X1, X2, threshold);
}
}
...
Java_com_mahmoodms_bluetooth_eegssvepwheelchairdemo_DeviceControlActivity_jmainInitialization(
    ...
    if (!(bool) terminate) {
        classifySSVEP4_initialize();
        classifySSVEP5_initialize();
        return 0;
    } else {
        return -1;
    }
